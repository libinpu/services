        ...
        <View style={styles.dashHeader}>
          <View style={styles.dashHeaderTop}>
            ...
            <View style={styles.onlineToggleWrap}>
              <Switch value={isOnline} onValueChange={toggleOnline} trackColor={{ false: colors.neutral[300], true: colors.success[500] }} thumbColor={isOnline ? colors.success[600] : colors.neutral[0]} />
...
const styles = StyleSheet.create({
  ...
  tab: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, paddingVertical: spacing.sm, borderRadius: radius.md, backgroundColor: colors.neutral[0], ...shadows.sm },
  ...
  jobCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.neutral[0], borderRadius: radius.lg, padding: spacing.md, marginBottom: spacing.sm, ...shadows.sm },
  ...
  jobStatusBadge: { paddingHorizontal: spacing.sm, paddingVertical: 2, borderRadius: radius.sm },
  ...
  jobAcceptBtn: { width: 40, height: 40, borderRadius: radius.full, backgroundColor: colors.success[600], alignItems: 'center', justifyContent: 'center' },
  jobRejectBtn: { width: 40, height: 40, borderRadius: radius.full, backgroundColor: colors.error[50], alignItems: 'center', justifyContent: 'center', borderWidth: 1.5, borderColor: colors.error[200] },
  switchSection: { paddingHorizontal: spacing.md, marginTop: spacing.xl },
  switchBtn: { width: '100%' },
  pendingCard: { alignItems: 'center', padding: spacing.xl, margin: spacing.md, backgroundColor: colors.neutral[0], borderRadius: radius.lg, ...shadows.sm },
  ...
  pendingInfoCard: { backgroundColor: colors.neutral[50], borderRadius: radius.lg, padding: spacing.md, width: '100%', marginBottom: spacing.lg },
  ...
  welcomeCard: { alignItems: 'center', padding: spacing.xl, margin: spacing.md, backgroundColor: colors.neutral[0], borderRadius: radius.lg, ...shadows.sm },
  ...
  modalCard: { backgroundColor: colors.neutral[0], borderTopLeftRadius: radius.xl, borderTopRightRadius: radius.xl, paddingBottom: spacing.xl },
  ...
  modalJobInfo: { backgroundColor: colors.neutral[50], borderRadius: radius.lg, padding: spacing.md, marginHorizontal: spacing.lg, marginTop: spacing.md },
  ...
  modalRejectBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, height: 52, borderRadius: radius.md, backgroundColor: colors.error[50], borderWidth: 1.5, borderColor: colors.error[200] },
  modalRejectText: { fontSize: typography.sizes.md, fontWeight: '700', color: colors.error[600], fontFamily: typography.fontFamilyBold },
  modalAcceptBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, height: 52, borderRadius: radius.md, backgroundColor: colors.success[600] },
