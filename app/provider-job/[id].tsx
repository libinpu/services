...
const styles = StyleSheet.create({
  ...
  statusBanner: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: spacing.md, paddingVertical: spacing.md, marginHorizontal: spacing.md, marginTop: spacing.md, borderRadius: radius.md },
  ...
  customerCard: { flexDirection: 'row', backgroundColor: colors.neutral[0], borderRadius: radius.lg, padding: spacing.md, ...shadows.sm },
  ...
  actionBtn: { width: '100%' },
  otpSection: { backgroundColor: colors.neutral[0], borderRadius: radius.lg, padding: spacing.lg, marginHorizontal: spacing.md, marginTop: spacing.lg, ...shadows.sm },
  ...
  otpInput: { width: 56, height: 64, borderRadius: radius.md, borderWidth: 2, borderColor: colors.neutral[300], fontSize: typography.sizes.xxxl, fontWeight: '700', color: colors.neutral[900], backgroundColor: colors.neutral[50], fontFamily: typography.fontFamilyBold },
  ...
  progressHeader: { alignItems: 'center', padding: spacing.xl, backgroundColor: colors.neutral[0], borderRadius: radius.lg, ...shadows.sm },
  ...
  confirmCard: { alignItems: 'center', padding: spacing.xl, margin: spacing.md, backgroundColor: colors.neutral[0], borderRadius: radius.lg, ...shadows.sm },
  ...
  completedCard: { alignItems: 'center', padding: spacing.xl, margin: spacing.md, backgroundColor: colors.neutral[0], borderRadius: radius.lg, ...shadows.sm },
  ...
  contactBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, height: 48, backgroundColor: colors.neutral[0], borderRadius: radius.md, ...shadows.sm },
  ...
  selfieCard: { flex: 1, backgroundColor: colors.neutral[0], marginTop: 60, borderTopLeftRadius: radius.xl, borderTopRightRadius: radius.xl, padding: spacing.lg },
  ...
  cameraArea: { flex: 1, borderRadius: radius.lg, overflow: 'hidden', marginTop: spacing.lg, backgroundColor: colors.neutral[900] },
  ...
  retakeBtn: { height: 48, borderRadius: radius.md, backgroundColor: colors.neutral[100], alignItems: 'center', justifyContent: 'center' },
  retakeBtnText: { fontSize: typography.sizes.md, fontWeight: '600', color: colors.neutral[600], fontFamily: typography.fontFamilyMedium },
